                            ...
                            <div id="shopify-section-rsvp-template" class="shopify-section">
                                <div class="page_rsvp_content">
                                    ...
                                    <div class="rsvp_content">
                                        <form method="post" action="<?= base_url('home/addPendaftarMahasiswa'); ?>" id="contact_form" class="contact-form" accept-charset="UTF-8">
                                            <div id="contactFormWrapper" class="contactFormWrapper">
                                                <div class="contactFormWrapper_inner">
                                                    ...
                                                    <p class="col-sm-12 input-row">
                                                        <input type="email" id="email" name="email" placeholder="Email address *" value="PAKET FREE Mahasiswa Itenas" readonly>
                                                    </p>
                                                    <hr>
